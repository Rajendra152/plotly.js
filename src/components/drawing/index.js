...
//item-height
drawing.pointStylesymbolheight = function (s, trace, gd) {
    if (!s.size()) return;

    var fns = drawing.makePointStyleFns(trace);
    s.each(function (d) {
      drawing.singlePointStylesymbolheight(
        d,
        d3.select(this),
        trace,
        fns,
  ...
  drawing.singlePointStylesymbolheight = function (
    d,
    sel,
    trace,
    fns,
    ...
    sel.style(
      "opacity",
      fns.selectedOpacityFn
        ? fns.selectedOpacityFn(d)
        : d.mo === undefined
        ? marker.opacity
        : d.mo
    );

    let itemheight = gd.layout.legend.inpixonCustomAttribute.itemheight;
    if (fns.ms2mrc) {
      var r;
    ...
    if (d.so) {
      ...
      else if (Lib.isArrayOrTypedArray(markerLine.color))
    ...
    if (d.om) {
      ...
      var patternShape =
        markerPattern &&
        drawing.getPatternAttr(markerPattern.shape, d.i, "");
      ...
      if (gradientType && gradientType !== "none") {
        ...
        var patternBGColor = drawing.getPatternAttr(
          markerPattern.bgcolor,
          d.i,
          null
        );
        var patternFGColor = drawing.getPatternAttr(
          markerPattern.fgcolor,
          d.i,
          null
        );
        var patternFGOpacity = markerPattern.fgopacity;
        var patternSize = drawing.getPatternAttr(
          markerPattern.size,
          d.i,
          8
        );
        var patternSolidity = drawing.getPatternAttr(
          markerPattern.solidity,
          d.i,
          0.3
        );
        var perPointPattern =
        ...
        (trace &&
          trace.marker &&
          trace.marker.fillPattern &&
          trace.marker.fillPattern != "none") ||
        (trace &&
          trace._input &&
          trace._input.fillPattern &&
          trace._input.fillPattern != "none") ||
        (gd &&
          gd.data &&
          gd.data.length > 0 &&
          gd.data[0].marker &&
          gd.data[0].marker.fillPattern &&
          gd.data[0].marker.fillPattern != "none")
      ) {
        var fillPattern;
        if (
          trace &&
          ...
          fillPattern = trace.marker.fillPattern;
        } else if (
          trace &&
          trace &&
          trace._input &&
          ...
          fillPattern = trace._input.fillPattern;
        } else if (
          gd &&
          gd.data &&
          gd.data.length > 0 &&
          ...
          fillPattern = gd.data[0].marker.fillPattern;
        }
        sel.style({ fill: "url(" + fillPattern + ")" });
      } else if (
        (trace &&
          trace.marker &&
          trace.marker.fillGradient &&
          trace.marker.fillGradient != "none") ||
        (trace &&
          trace._input &&
          trace._input.fillGradient &&
          trace._input.fillGradient != "none") ||
        (gd &&
          gd.data &&
          gd.data.length > 0 &&
          gd.data[0].marker &&
          gd.data[0].marker.fillGradient &&
          gd.data[0].marker.fillGradient != "none")
      ) {
        var fillGradient;
        if (
          trace &&
          ...
          fillGradient = trace.marker.fillGradient;
        } else if (
          trace &&
          trace &&
          trace._input &&
          ...
          fillGradient = trace._input.fillGradient;
        } else if (
          gd &&
          gd.data &&
          gd.data.length > 0 &&
          ...
          fillGradient = gd.data[0].marker.fillGradient;
        }
        sel.style({ fill: "url(" + fillGradient + ")" });
      } else {
