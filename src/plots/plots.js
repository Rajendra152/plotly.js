...
plots.supplyDefaults = function(gd, opts) {
    ...
    if(oldFullLayout._initialAutoSizeIsDone) {
        ...
        // for new custom attribute: inpixon customisation - symbol placement
        var newattributes = gd.layout.legend.inpixonCustomAttribute || {};
    ...
    //inpixon customisation - symbol placement
    newFullLayout.inpixonCustomAttribute = newattributes;
