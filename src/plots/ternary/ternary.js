...
proto.drawAx = function(ax) {
    ...
    var w = _this.w;
    var h = _this.h;
    //inpixon custimisation for ternary ticks
    var tickPath =
    //baxis
    axLetter === "b" && ax.ticks === 'outside' || axLetter === "b"  && ax.ticks === 'inside'  ? "M0," +pad +"l" + Math.sin(caRad + 1) * len +"," + Math.cos(caRad) * len : 
    axLetter === "b" && ax.ticks === 'both' ? `M${-Math.sin(caRad + 1) * len/2},` + -Math.sin(caRad + 1) * len/2 +"l" + Math.sin(caRad + 1) * len +"," + Math.cos(caRad) * len :
    axLetter === "b" && ax.ticks === '90Out' ? "M0," +pad +"l" + Math.sin(caRad + 1) * len * 0 +"," + Math.cos(caRad) * len :
    axLetter === "b" && ax.ticks === '90In' ? "M0," + -pad +"l" + Math.sin(caRad + 1) * len * 0 +"," + -Math.cos(caRad) * len :
    axLetter === "b" && ax.ticks === '90InOut' ? "M0," + Math.cos(caRad) * len/2  +"l" + Math.sin(caRad + 1) * len * 0 +"," + -Math.cos(caRad) * len :
    axLetter === "b" && ax.ticks === 'ccwOut' ? "M0," + -pad +"l" + Math.sin(caRad + 1) * -len + "," + Math.cos(caRad) * len :
    axLetter === "b" && ax.ticks === 'ccwIn' ? `M${Math.sin(caRad + 1) * len},` +  Math.cos(caRad) * -len +"l" + Math.sin(caRad + 1) * -len  + "," +  Math.cos(caRad) * len :
    axLetter === "b" && ax.ticks === 'ccwInOut' ? `M${Math.sin(caRad + 1) * len/2 + 2},` + Math.sin(caRad + 1) * -len /2  +"l" + Math.sin(caRad + 1) * -len + "," + Math.cos(caRad) * len :
    //aaxis
    axLetter === "a" && ax.ticks === 'outside' || axLetter === "b"  && ax.ticks === 'inside' ? "M" +pad + ",0l" +Math.cos(caRad) * len +"," + -Math.sin(caRad) * len : //90 in out
    axLetter === "a" && ax.ticks === 'both' ? `M${-(Math.cos(caRad) * len)/2}`  + `,${(Math.sin(caRad) * len - 2)/2}l` +Math.cos(caRad) * len +"," + -Math.sin(caRad) * len : // 90 both
    axLetter === "a" && ax.ticks === '90Out' ? "M" + pad + ",0l" +Math.cos(caRad) * len +"," + 0 :
    axLetter === "a" && ax.ticks === '90In' ? "M" + Math.cos(caRad) * -len + ",0l" +Math.cos(caRad) * len +"," + 0 :
    axLetter === "a" && ax.ticks === '90InOut' ? "M" + (Math.cos(caRad) * -len)/2 + ",0l" +Math.cos(caRad) * len +"," + 0 :
    axLetter === "a" && ax.ticks === 'ccwOut' ? "M" +pad + ",0l" +Math.cos(caRad) * len +"," + Math.sin(caRad) * len :
    axLetter === "a" && ax.ticks === 'ccwIn' ? `M${Math.cos(caRad) * -len + 0.5 },` +  Math.sin(caRad) * -len  + 1 +"l" + Math.cos(caRad) * len + 6+ "," +  Math.sin(caRad) * len :
    axLetter === "a" && ax.ticks === 'ccwInOut' ? `M${(Math.cos(caRad) * -len + 0.5)/ 2},` +  (Math.sin(caRad) * -len)/2  + 1  +"l" + Math.cos(caRad) * len + 6+ "," +  Math.sin(caRad) * len :
    //caxis
    axLetter === "c" && ax.ticks === 'both' ? `M${-(Math.cos(caRad) * len)/2}`  + `,${(Math.sin(caRad) * len - 2)/2}l` +Math.cos(caRad) * len +"," + -Math.sin(caRad) * len :
    axLetter === "c" && ax.ticks === '90Out' ? "M" + pad + ",0l" +Math.cos(caRad) * len +"," + 0 :
    axLetter === "c" && ax.ticks === '90In' ? "M" + Math.cos(caRad) * -len + ",0l" +Math.cos(caRad) * len +"," + 0 :
    axLetter === "c" && ax.ticks === '90InOut' ? "M" + (Math.cos(caRad) * -len)/2 + ",0l" +Math.cos(caRad) * len +"," + 0 :
    axLetter === "c" && ax.ticks === 'ccwOut' ? "M" +pad + ",0l" +Math.cos(caRad) * len +"," + Math.sin(caRad) * len :
    axLetter === "c" && ax.ticks === 'ccwIn' ? `M${Math.cos(caRad) * -len + 0.5 },` +  Math.sin(caRad) * -len  + 1 +"l" + Math.cos(caRad) * len + 6+ "," +  Math.sin(caRad) * len :
    axLetter === 'c' && ax.ticks === 'ccwInOut' ? `M${(Math.cos(caRad) * -len + 0.5)/ 2},` +  (Math.sin(caRad) * -len)/2  + 1  +"l" + Math.cos(caRad) * len + 6+ "," +  Math.sin(caRad) * len:
