...
function plotOne(gd, idx, plotinfo, cdscatter, cdscatterAll, element, transitionOpts) {
    ...
    if (abovetraceAttribute === true
         ...
         tr.select("g.points").remove();
         tr.select("g.lines").remove();
    ...
    var ownFillDir1 = trace.fill.charAt(trace.fill.length - 2); //inpixon customisation - area fills
    ...
    //inpixon customisation - area fills
    ...
    function getMinMax(arr) {
      ...
      var xArray = gd.data[0].x;
      var yArray = gd.data[0].y;
        ...
        if(ownFillEl3) {
            ...
            if(pt0 && pt1) {
                if(ownFillDir) {
                    ...
                    if (
                        ownFillDir === "y" &&
                        (ownFillDir1 === "o" || ownFillDir1 === "t")
                      ) {
                        pt0[1] = pt1[1] = ya.c2p(0, true);
                      } else if (ownFillDir === "y" && ownFillDir1 === "x") {
                        var yMax = getMinMax(yArray);
                        pt0[1] = pt1[1] = ya.c2p(2 * yMax, true);
                      } else if (
                        ownFillDir === "x" &&
                        (ownFillDir1 === "o" || ownFillDir1 === "t")
                      ) {
                        pt0[0] = pt1[0] = xa.c2p(0, true);
                      } else if (ownFillDir === "x" && ownFillDir1 === "x") {
                        var xMax = getMinMax(xArray);
                        pt0[0] = pt1[0] = xa.c2p(2 * xMax, true);
                      }
